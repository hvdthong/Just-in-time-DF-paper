...
\hspace{2mm} \texttt{Updates to the SecurityGroupRule model and migration so that we explicitly name the securitygrouprules.direction enum. This fixes 'Postgresql ENUM type requires a name.' errors.} \\
\hspace{2mm} \texttt{Fixes LP Bug \#1099267.} \\
\hspace{2mm} \texttt{Change-Id: Ia46fe8d4b0793caaabbfc71b7fa5f0cbb8c6d24b}
