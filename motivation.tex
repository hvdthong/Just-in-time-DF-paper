...
We firstly present an example of commit change motivating our deep learning framework, we then briefly present a background knowledge about Convolutional Neural Network (CNN) which is a key architecture in our paper.
