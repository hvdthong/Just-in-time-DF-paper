...
& Subsystems & The number of modified subsystems. & Scattered changes may have defects compared to focused ones~\cite{Ambros2010, hassan2009icse}. \\
\cline{2-3}
...
& Unique changes & The number of prior changes to the modified files. & More changes intend to have defects since developers need to track many previous changes~\cite{Kamei:2013:LES}.\\
\cline{2-4}
